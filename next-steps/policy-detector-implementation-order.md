...
| 21 | `rules/policies/*.yaml` | Fornire policy demo | Completato: preset esistenti e policy minima `temp-script-write-exec` con i soli eventi necessari | `pkg/policy` | Caricate da CLI |
